...
public class HostTest {
    ...
    public void testRegisterMultiplePlayers() {
        ...
        assertThat(players, containsInAnyOrder(new Player(CLIENT_NAME, CLIENT_HOST, CLIENT_PORT), new Player("player2Url", "player2", 8080)));
    }
    ...
    private RoutingContext createRoutingContext(String clientName, String clientHost, int clientPort) {
        ...
        when(context.request().getParam("host")).thenReturn(clientHost);
